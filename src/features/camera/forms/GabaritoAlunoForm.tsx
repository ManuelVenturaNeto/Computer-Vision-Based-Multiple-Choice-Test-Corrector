...
export function GabaritoAlunoForm(props: GabaritoAlunoFormProps) {
  const { alunoNome, capturedImage, answerSheetError, answerSheetInfo, respostas, numQuestoes, alternativeCount, errors, onRespostaChange, onRetry } = props;
  ...
  return (
    <>
      ...
      <AnswerOptionsGrid numQuestoes={numQuestoes} alternativeCount={alternativeCount} respostas={respostas} onRespostaChange={onRespostaChange} />
